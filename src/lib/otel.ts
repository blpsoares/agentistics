...
export const METRIC_DESCRIPTORS: MetricDescriptor[] = [
  // Cumulative totals — ObservableCounter (monotonically increasing)
  ...
  // Point-in-time values — ObservableGauge
  { name: 'claude_stats.streak',                 description: 'Current streak (consecutive active days)', unit: '{days}',  type: 'gauge' },
  { name: 'claude_stats.longest_session',        description: 'Longest session duration in minutes',  unit: 'min',        type: 'gauge' },
