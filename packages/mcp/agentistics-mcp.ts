    ...
    inputSchema: {
      ...
      properties: {
        ...
        parentGroupId: {
          type: "string",
          description:
            "Join this subtask (named by `id`) to the group whose id this names — a group of the SAME parent task. Pass an empty string to leave the current group. Refused (422, `invalid_group`) if the id is not an actual group of this task, or if this subtask is itself a group.",
        },
      },
      required: ["ref"],
    },
