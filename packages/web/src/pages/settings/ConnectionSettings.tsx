  ...
  return (
    <div>
      ...
      <p style={{ fontSize: 12.5, color: 'var(--text-secondary)', lineHeight: 1.6, margin: '0 0 18px' }}>
        {pt
          ? 'Conecte esta máquina a uma central para enviar suas métricas — informe o endpoint, o token e o nome.'
          : 'Connect this machine to a central to push your metrics — enter the endpoint, token and name.'}
      </p>
      ...
      {loadErr ? (
        ...
        // onChange just syncs local state. central=false renders the member "Join central" branch.
