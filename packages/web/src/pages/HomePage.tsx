...
import { projectFolder, t } from '@agentistics/core'
...
export default function HomePage() {
  ...
  function renderCard(id: CardId) {
    ...
    if (id === 'messages') {
      ...
      card = (
        <StatCard label={lang === 'pt' ? 'Custo estimado' : 'Est. cost'} value={fmtCost(d.totalCostUSD, currency, brlRate)}
          ...
          sizeBasis={widerValue(fmtCost(d.totalCostUSD, 'USD', brlRate), fmtCost(d.totalCostUSD, 'BRL', brlRate))}
          sub={costCardSub(lang, filters.harness)} icon={<TrendingUp size={15} />} accent="var(--anthropic-orange)" info={infoItems[5]} onInfoClick={() => setInfoModalIndex(5)}
          action={
