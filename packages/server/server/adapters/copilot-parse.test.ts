...
// Minimal real-world-shaped sample based on the actual Copilot events.jsonl format
const SAMPLE = [
...
test('parses a copilot events.jsonl into a SessionMeta', () => {
  const s = parseCopilotEvents(SAMPLE, 'fallback-id')
