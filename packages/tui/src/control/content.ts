...
const HELP_EN: ContentSection[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      { text: 'Screens: Services (start/stop/restart this machine, a central or the Docker machine; connect to or leave a central; enable a boot service), Setup (solo / central / member and the history-preservation consent), Logs, Cheat sheet, Help, Contribute.' },
...
const HELP_PT: ContentSection[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      { text: 'Telas: Serviços (subir/parar/reiniciar esta máquina, uma central ou a máquina em Docker; conectar ou sair de uma central; ligar um serviço de boot), Setup (solo / central / member e o consentimento de preservação do histórico), Logs, Comandos, Ajuda, Contribuir.' },
